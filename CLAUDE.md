...
The Welcome Back top-section redesign flagged in the previous entry is **✅ DONE** and live (see above) — that supersedes item 2 in the 2026-07-19 list. Nothing urgent is broken; the two deploy scares from tonight are both fully resolved and root-caused, not just patched around. Open items:
1. **▶ ASK CATH:** the dead duplicate "See my Style Portrait" row in the Welcome Back menu (found tonight, see above) — restore it to visibility, or leave it dormant?
