...
The **gold-buttons → cream sweep is DONE & live** (PR #474). The outfit-results glow-up (PRs #439–#451) and the pref-done/hub-spacing work (PRs #452–#473) are all live too. Pick the next lever. Still open / candidate next steps:
