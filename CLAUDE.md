...
Huge Your Wardrobe session shipped (PRs #550–#565) — all live, nothing broken. Cath loves it. **▶ TOP PRIORITY when she's next at her desk: the TWO email projects (do them together — same backend investment):**
...
3. **Your Wardrobe parked micro-features**: "NEW" badge on What's Trending when Cath updates it (`ss_trending_seen` stamp, mirror the Edit "NEW" pill); the "not right now" mute on Want items. Also: possibly rename the wantlist masthead "shop your style" → "shop your list"; possibly a two-line "BUILDING YOUR WARDROBE" hub label.
