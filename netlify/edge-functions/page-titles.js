...
const ARTICLES = [
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'Can I Still Wear My Summer Dresses in Fall?', a: 'Yes. A great dress is a great dress. Before you pack anything away, look at each one for its color, its print, its overall feeling rather than its sleeve length. A surprising number will move straight into October with nothing more than a different shoe, a different bag, or a piece of jewelry with more presence. Three ideas that work: An off white sleeveless midi, tan leather loafers, and a suede crossbody. Nothing about that outfit is warm, and all of it reads as fall. The white jeans you\'ve worn all summer, an olive linen button-down with the sleeves rolled, and flat leather slides in cognac. A burgundy or deep green sundress, a slim leather belt at the waist, and a closed-toe flat. The belt is doing more work than you\'d think.' },
