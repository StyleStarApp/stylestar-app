...
ok('allowed_domains is the server-side 101-store list', Array.isArray(tool.allowed_domains) && tool.allowed_domains.length === 101 && tool.allowed_domains.includes('nordstrom.com'));
...
ok('URL outside the 101 stores rejected, falls back to search link', linkCases.offList);
